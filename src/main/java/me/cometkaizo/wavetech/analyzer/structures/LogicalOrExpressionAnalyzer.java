...
public class LogicalOrExpressionAnalyzer implements ProgramContextAnalyzer {
    private final LogicalOrExpression expression;
    boolean analyzed = false;

    public LogicalOrExpressionAnalyzer(LogicalOrExpression expression) {
    ...
    private static void analyze(List<Diagnostic> problems, ResourcePool resources, LogicalAndExpression expr) {
        expr.getAnalyzer().analyze(problems, resources);
    }

    private LogicalAndExpression getFirstExpr() {
