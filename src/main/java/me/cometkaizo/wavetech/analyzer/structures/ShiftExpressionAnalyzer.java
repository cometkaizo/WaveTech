...
public class ShiftExpressionAnalyzer implements ProgramContextAnalyzer {
    private final ShiftExpression expression;
    boolean analyzed = false;

    public ShiftExpressionAnalyzer(ShiftExpression expression) {
    ...
    private static void analyze(List<Diagnostic> problems, ResourcePool resources, AdditiveExpression expr) {
        expr.getAnalyzer().analyze(problems, resources);
    }

    private AdditiveExpression getFirstExpr() {
