...
public class BitwiseOrExpressionAnalyzer implements ProgramContextAnalyzer {
    private final BitwiseOrExpression expression;
    boolean analyzed = false;

    public BitwiseOrExpressionAnalyzer(BitwiseOrExpression expression) {
    ...
    private static void analyze(List<Diagnostic> problems, ResourcePool resources, BitwiseXorExpression expr) {
        expr.getAnalyzer().analyze(problems, resources);
    }

    private BitwiseXorExpression getFirstExpr() {
