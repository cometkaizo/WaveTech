...
public class BitwiseXorExpressionAnalyzer implements ProgramContextAnalyzer {
    private final BitwiseXorExpression expression;
    boolean analyzed = false;

    public BitwiseXorExpressionAnalyzer(BitwiseXorExpression expression) {
    ...
    private static void analyze(List<Diagnostic> problems, ResourcePool resources, BitwiseAndExpression expr) {
        expr.getAnalyzer().analyze(problems, resources);
    }

    private BitwiseAndExpression getFirstExpr() {
