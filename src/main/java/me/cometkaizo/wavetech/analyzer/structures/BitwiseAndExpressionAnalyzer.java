...
public class BitwiseAndExpressionAnalyzer implements ProgramContextAnalyzer {
    private final BitwiseAndExpression expression;
    boolean analyzed = false;

    public BitwiseAndExpressionAnalyzer(BitwiseAndExpression expression) {
    ...
    private static void analyze(List<Diagnostic> problems, ResourcePool resources, EqualityExpression expr) {
        expr.getAnalyzer().analyze(problems, resources);
    }

    private EqualityExpression getFirstExpr() {
