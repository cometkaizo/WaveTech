...
import me.cometkaizo.wavetech.analyzer.structures.MultiplicativeExpressionAnalyzer;
...
public class MultiplicativeExpression extends AbstractSyntaxStructure<ProgramContextAnalyzer> {

    public List<PrefixExpression> expressions = new ArrayList<>(2);
