...
import me.cometkaizo.wavetech.analyzer.structures.ShiftExpressionAnalyzer;
...
public class ShiftExpression extends AbstractSyntaxStructure<ProgramContextAnalyzer> {

    public List<AdditiveExpression> expressions = new ArrayList<>(2);
