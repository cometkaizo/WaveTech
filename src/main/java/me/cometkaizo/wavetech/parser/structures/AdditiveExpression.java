...
import me.cometkaizo.wavetech.analyzer.structures.AdditiveExpressionAnalyzer;
...
public class AdditiveExpression extends AbstractSyntaxStructure<ProgramContextAnalyzer> {

    public List<MultiplicativeExpression> expressions = new ArrayList<>(2);
