...
import me.cometkaizo.wavetech.analyzer.structures.BitwiseOrExpressionAnalyzer;
...
public class BitwiseOrExpression extends AbstractSyntaxStructure<ProgramContextAnalyzer> {

    public List<BitwiseXorExpression> expressions = new ArrayList<>(2);
    ...
    public boolean equals(Object o) {
        ...
        BitwiseOrExpression that = (BitwiseOrExpression) o;
